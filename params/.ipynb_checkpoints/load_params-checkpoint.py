...
matrix_s2al2ab4b3b2_to_xyzd65_lei = np.loadtxt(os.path.join(_path,'S2AL2Ab4b3b2_to_XYZd65_lei.csv'),delimiter=',')
matrix_s2bl2ab4b3b2_to_xyzd65_lei = np.loadtxt(os.path.join(_path,'S2BL2Ab4b3b2_to_XYZd65_lei.csv'),delimiter=',')
